...
trait RoleAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        if(access()->allow('edit-roles')){
            return '<a href="'.route('admin.access.roles.edit', $this->id).'" class="btn btn-primary btn-xs"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a>';
        }
