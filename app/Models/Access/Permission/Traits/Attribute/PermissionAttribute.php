...
trait PermissionAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        if(access()->allow('edit-permissions')){
            return '<a href="'.route('admin.access.roles.permissions.edit', $this->id).' " class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tool-tip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a>';
        }
