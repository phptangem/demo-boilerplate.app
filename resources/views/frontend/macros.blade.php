        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-home"></i> {{trans('labels.frontend.macros.macro_examples')}}
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.state.us.us')}}</label>
                        {!! Form::selectStateUS('state', 'NY', ['class' => 'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.state.us.outlying')}}</label>
                        {!! Form::selectStateUSOutlyingTerritories('state_outlying',null,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.state.us.armed')}}</label>
                        {!! Form::selectStateUSArmedForces('armed_forces',null,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.territories.canada')}}</label>
                        {!! Form::selectCanadaTerritories('canada_territories',null,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.state.mexico')}}</label>
                        {!! Form::selectStateMexico('mexico',null,['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.country.alpha')}}</label>
                        {!! Form::selectCountryAlpha('country_alpha','ISO 3166-2:US',['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.country.alpha2')}}</label>
                        {!! Form::selectCountryAlpha2('country_alpha2','US',['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        <label for="">{{trans('labels.frontend.macros.country.alpha3')}}</label>
