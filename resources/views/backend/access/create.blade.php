...
@endsection
@section('content')
    {!! Form::open(['route'=>'admin.access.users.store', 'class'=>'form-horizontal', 'method'=>'post']) !!}
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="confirmed" class="col-lg-2 control-label">{{ trans('validation.attributes.backend.access.users.confirmed') }}</label>
                    <div class="col-lg-1">
