        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="hidden" id="available-permissions">
                        <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if($permissions->count())
                                        @foreach($permissions as $perm)
                                            <input type="checkbox" name="ungrouped[]" value="{!! $perm->id !!}" id="perm_{!! $perm->id !!}" {{ in_array($perm->id, $role_permissions) ? 'checked':''  }} data-dependencies="{!! json_encode($perm->dependencies->lists('dependency_id')->all()) !!}">
                                            <label for="perm_{!! $perm->id !!}">
                                                @if($perm->dependencies->count())
                                                    <?php
                                                        $dependency_list = [];
                                                        foreach($perm->dependencies as $dependency)
                                                            array_push($dependency_list, $dependency->permissions->display_name);
                                                        $dependency_list = implode(', ',$dependency_list);
                                                    ?>
