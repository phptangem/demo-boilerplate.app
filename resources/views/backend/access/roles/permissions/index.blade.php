        ...
        <div class="box-body">
            <div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="groups" style="padding-top:20px">
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <ol class="dd-list">
                                        @foreach($groups as $group)
                                                <li class="dd-item" data-id="{!! $group->id !!}">
                                                    <div class="dd-handle">
                                                        {!! $group->name !!} <span class="pull-right">{!! $group->permissions->count() !!} {{ trans('labels.backend.access.permissions.label') }}</span>
                                                    </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="permissions" style="padding-top: 20px">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
