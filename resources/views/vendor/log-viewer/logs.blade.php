...
@section('content')
    ...
    <div class="modal fade" id="delete-log-modal">
        <div class="modal-dialog">
            <form action="{{route('log-viewer::logs.delete')}}" method="POST" id="delete-log-form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-sm btn-default pull-left" type="button" data-dismiss="modal">Cancel</button>
                        <button class="btn btn-sm btn-danger" type="submit" data-loading-text="Loading&hellip;">DELETE FILE</button>
                    </div>
                </div>
            </form>
        </div>
